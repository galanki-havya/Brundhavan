        ...
        >
          ...
          >
            ...
            <h2 style={{
              ...
              Future-Ready{' '}
              <span style={{ color: '#FF6347', fontStyle: 'italic', fontWeight: 400 }}>Smart Classrooms</span>
            </h2>
            ...
            {[
              'Smart interactive whiteboards in every classroom',
              'Video animations & audio-visual tutorials',
              'Real-time student engagement tools',
              'Digital assessments & instant feedback',
              'Seamlessly integrated with the curriculum'
            ].map((point, i) => (
      ...
      <section style={{ padding: '80px 0', background: '#F9FAFB' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
            {[
              { emoji: '🖥️', label: 'Interactive Displays', desc: 'Large touch-screen displays for collaborative learning and multimedia presentations.' },
              { emoji: '📚', label: 'Digital Content', desc: 'Access to vast digital libraries, educational videos, and interactive simulations.' },
              { emoji: '👥', label: 'Student Engagement', desc: 'Tools that promote active participation and real-time feedback from every student.' },
              { emoji: '⚡', label: 'Modern Technology', desc: 'Latest educational software and hardware delivering 21st-century learning outcomes.' },
            ].map((item, i) => (
              <motion.div
                key={i}
