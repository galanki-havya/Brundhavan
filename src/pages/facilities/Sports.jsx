...
import { Trophy, Users, Star, Dumbbell, CheckCircle2, ArrowRight, Activity, Award, Target, Flame, Crown, Heart, Music } from 'lucide-react'
import sportsImg from '../../assets/Facilties/4.jpg'
import sportsRightImg from '../../assets/rightimages/4.png'

const featureCards = [
  { label: 'Competitive Edge', desc: 'Coaching teams for regional and inter-school tournaments.',        bg: '#FFF8F6', border: '#FFCFC4' },
  { label: 'Inclusive Play',   desc: 'Ensuring every student participates in physical training daily.', bg: '#EEF3FB', border: '#B8CFF0' },
  { label: 'Skill Guided',     desc: 'Focused instruction for rules, strategy, and agility.',           bg: '#FFFBEE', border: '#F5DFA0' },
  { label: 'Modern Gear',      desc: 'Premium equipment and safety gear for all students.',             bg: '#F0FAF4', border: '#A8DDB8' },
]
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: '52px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <span style={{ color: '#FF6347', fontWeight: 600, fontSize: 11, letterSpacing: '3px', textTransform: 'uppercase' }}>Sports Highlights</span>
              <span style={{ height: 1, width: 24, background: '#FF6347', display: 'inline-block' }} />
            </div>
