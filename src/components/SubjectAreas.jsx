...
const subjects = [
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <text x="11" y="27" fontFamily="Georgia,serif" fontSize="13" fontWeight="bold" fill={o}>A</text>
        ...
        <text x="33" y="34" fontFamily="serif" fontSize="14" fontWeight="bold" fill={o}>文</text>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <text x="18" y="28" fontFamily="Georgia,serif" fontSize="11" fontWeight="bold" fill={o}>×</text>
        <text x="35" y="28" fontFamily="Georgia,serif" fontSize="11" fontWeight="bold" fill={o}>÷</text>
        <text x="19" y="44" fontFamily="Georgia,serif" fontSize="11" fontWeight="bold" fill={o}>+</text>
        <text x="35" y="44" fontFamily="Georgia,serif" fontSize="12" fontWeight="bold" fill={o}>−</text>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <path d="M16 46 Q32 38 48 46 L54 56 L10 56 Z" fill={o} opacity="0.15"/>
        <circle cx="26" cy="44" r="3" fill={o} opacity="0.7"/>
        <circle cx="36" cy="40" r="2" fill={o} opacity="0.5"/>
        <circle cx="42" cy="46" r="2.5" fill={o} opacity="0.6"/>
        <circle cx="10" cy="20" r="2" fill={o}/>
        <line x1="10" y1="20" x2="24" y2="26" stroke={o} strokeWidth="1.5" opacity="0.6"/>
        <circle cx="54" cy="20" r="2" fill={o}/>
        <line x1="54" y1="20" x2="40" y2="26" stroke={o} strokeWidth="1.5" opacity="0.6"/>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <text x="23" y="36" fontFamily="Georgia,serif" fontSize="13" fontWeight="bold" fill={o}>AI</text>
  ...
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <circle cx="20" cy="24" r="5" fill={o}/>
        <path d="M12 42 Q20 34 28 42" stroke={o} strokeWidth="2" fill={o} opacity="0.85"/>
        <circle cx="32" cy="21" r="6" fill={o}/>
        <path d="M22 42 Q32 32 42 42" stroke={o} strokeWidth="2" fill={o}/>
        <circle cx="44" cy="24" r="5" fill={o}/>
        <path d="M36 42 Q44 34 52 42" stroke={o} strokeWidth="2" fill={o} opacity="0.85"/>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <circle cx="14" cy="24" r="2" fill={o}/>
        <circle cx="22" cy="22" r="2" fill={o}/>
        ...
        <circle cx="42" cy="24" r="2" fill={o}/>
        <circle cx="50" cy="22" r="2" fill={o}/>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <path d="M14 42 L26 22 L38 42 Z" stroke={o} strokeWidth="1.8" fill={o} fillOpacity="0.15"/>
        <line x1="42" y1="20" x2="42" y2="28" stroke={o} strokeWidth="2.5" strokeLinecap="round"/>
        <line x1="38" y1="24" x2="46" y2="24" stroke={o} strokeWidth="2.5" strokeLinecap="round"/>
        <rect x="54" y="16" width="5" height="20" rx="2" stroke={n} strokeWidth="1.5" fill="none"/>
        <path d="M54 36 L56.5 42 L59 36 Z" fill={o}/>
      </svg>
    ),
  },
  {
    ...
    icon: (o, n) => (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="54" height="54">
        ...
        <line x1="4"  y1="28" x2="18" y2="28" stroke={o} strokeWidth="2.5" strokeLinecap="round"/>
        <line x1="8"  y1="36" x2="18" y2="36" stroke={o} strokeWidth="2"   strokeLinecap="round"/>
        <line x1="12" y1="44" x2="20" y2="44" stroke={o} strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
  },
]
  ...
  return (
    <section style={{
      ...
      <style>{`
        ...
        .sa-card:hover {
          border-color: rgba(236, 115, 58, 0.4);
          box-shadow: 0 10px 30px rgba(236, 115, 58, 0.08);
