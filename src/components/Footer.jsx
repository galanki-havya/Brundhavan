...
export default function Footer() {
  ...
  return (
    <footer style={{ background: 'rgb(1, 30, 58)', color: '#fff', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="footer-inner" style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 40px' }}>
        <div className="footer-grid">

          {/* BRAND & LOGO */}
          <div className="footer-brand">
            <div style={{ height: '60px', display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
              <img src={logo} alt="School Logo" style={{ maxHeight: '100%', width: 'auto', display: 'block' }} />
            </div>
            <p style={{ fontSize: '14px', color: '#cbd5e1', lineHeight: 1.8, marginBottom: '24px', maxWidth: '340px' }}>
          ...
          {/* NAVIGATION */}
          <div>
            <h4 style={{ fontSize: '14px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '25px', color: '#ec733a', letterSpacing: '1px' }}>
              Quick Links
            </h4>
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '15px' }}>
              {quickLinks.map(link => (
                <li key={link.name}>
                  <NavLink
                    to={link.path}
                    style={{ fontSize: '14px', color: '#fff', textDecoration: 'none', display: 'flex', alignItems: 'center', opacity: 0.8, transition: '0.2s' }}
                  ...
                  >
                    <ChevronRight size={16} style={{ marginRight: '8px', flexShrink: 0 }} /> {link.name}
                  </NavLink>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '18px', fontSize: '14px', opacity: 0.9 }}>
              <div style={{ display: 'flex', gap: '12px' }}>
                <MapPin size={20} style={{ color: '#ec733a', flexShrink: 0, marginTop: '2px' }} />
                <span style={{ lineHeight: 1.6 }}>{school.address}</span>
              </div>
              ...
              <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                <a href={`mailto:${school.email}`} style={{ color: '#fff', textDecoration: 'none', wordBreak: 'break-all' }}>{school.email}</a>
              </div>
            </div>
          </div>
      ...
      {/* ── BOTTOM BAR ── */}
      <div className="footer-bottom" style={{ borderTop: '1px solid rgba(255,255,255,0.1)', padding: '20px 40px', textAlign: 'center', fontSize: '12px', color: '#94a3b8' }}>
